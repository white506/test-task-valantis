  ...
  if (loading) {
    return (
      <div className="loader">
        <img src="/dist/img/loading.webp" alt="Loader" />
      </div>
    );
  }
        ...
        <div key={item.id || index} className="product-item">
          <div className="product-item__image">
            {item.product.toLowerCase().includes("колье") ? (
              <img src="/dist/img/jewelry/pic_01.webp" alt="Product" />
            ) : item.product.toLowerCase().includes("кольцо") ? (
              <img src="/dist/img/jewelry/pic_02.webp" alt="Product" />
            ) : item.product.toLowerCase().includes("серьги") ? (
              <img src="/dist/img/jewelry/pic_03.webp" alt="Product" />
            ) : item.product.toLowerCase().includes("браслет") ? (
              <img src="/dist/img/jewelry/pic_04.webp" alt="Product" />
            ) : item.product.toLowerCase().includes("комплект") ? (
              <img src="/dist/img/jewelry/pic_05.webp" alt="Product" />
            ) : item.product.toLowerCase().includes("ложка") ? (
              <img src="/dist/img/jewelry/pic_10.webp" alt="Product" />
            ) : item.product.toLowerCase().includes("кулон") ? (
              <img src="/dist/img/jewelry/pic_06.webp" alt="Product" />
            ) : item.product.toLowerCase().includes("брошь") ? (
              <img src="/dist/img/jewelry/pic_07.webp" alt="Product" />
            ) : item.product.toLowerCase().includes("пусеты") ? (
              <img src="/dist/img/jewelry/pic_08.webp" alt="Product" />
            ) : item.product.toLowerCase().includes("цепь") ? (
              <img src="/dist/img/jewelry/pic_09.webp" alt="Product" />
            ) : (
              <img src="/dist/img/jewelry/pic_11.webp" alt="Product" />
            )}
          </div>
